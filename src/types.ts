...
/**
 * Map structure for storing logs with event and message as the unique key.
 * The key format is "event:message" to ensure uniqueness.
 */
export type LogMap = Map<string, LogEntry>;
